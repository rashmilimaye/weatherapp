...
const weatherOutput = document.getElementById('tempe');
...
function successCallback(position) {
    ...
    // Fetching weather conditions from the API depending on the user’s current location
...
function displayWeather(weatherData) {
    ...
    weatherOutput.innerHTML = `<p>${temperature}°C</p>
                               <p>  ${description}</p>`;
}
